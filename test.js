...
function handleLose() {
  ...
  if (playerScore === 15 || computerScore === 15) {
    redirectToGameOver(playerScore, computerScore);
  }
}

function redirectToGameOver(playerScore, computerScore) {
  window.location.href = `GameOver.html?playerScore=${playerScore}&computerScore=${computerScore}`;
}
